...
public interface IShowtimeService {
    ...
    MovieBriefResponse getMovieBriefShowtime(Long showtimeId);
    TheaterResponse getTheaterByShowtime(Long showtimeId);
    RoomBriefResponse getRoomByShowtime(Long showtimeId);
}
