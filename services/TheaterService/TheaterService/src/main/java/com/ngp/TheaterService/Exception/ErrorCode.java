package com.ngp.TheaterService.Exception;
...
public enum ErrorCode {
    ...
    THEATER_NOT_FOUND(1002, "Theater not found", HttpStatus.BAD_REQUEST),
    ROOM_NOT_FOUND(1002, "ROOM not found", HttpStatus.BAD_REQUEST),
    SEAT_NOT_FOUND(1002, "SEAT not found", HttpStatus.BAD_REQUEST),
    FOOD_NOT_FOUND(1002, "FOOD not found", HttpStatus.BAD_REQUEST),
    NOT_EMPTY(1003, "This field is not empty", HttpStatus.BAD_REQUEST),
    NOT_NULL(1004, "This field is not null", HttpStatus.BAD_REQUEST),
    THEATER_EXISTS(1005, "THEATER is already exist", HttpStatus.BAD_REQUEST),
    FOOD_EXISTS(1005, "FOOD is already exist", HttpStatus.BAD_REQUEST),
    ROOM_EXISTS(1005, "ROOM is already exist", HttpStatus.BAD_REQUEST),
    EXISTS(1005, "This object is already exist", HttpStatus.BAD_REQUEST),
    NOT_EXISTS(1006, "not exist", HttpStatus.NOT_FOUND),
    ROOM_NOT_EXISTS(1006, "Movie not exist", HttpStatus.NOT_FOUND),
