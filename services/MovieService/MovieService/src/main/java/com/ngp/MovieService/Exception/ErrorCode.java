package com.ngp.MovieService.Exception;
...
public enum ErrorCode {
    ...
    ACTOR_NOT_FOUND(1002, "Actor not found", HttpStatus.BAD_REQUEST),
    DIRECTOR_NOT_FOUND(1002, "Director not found", HttpStatus.BAD_REQUEST),
    ...
    MOVIE_NOT_EXISTS(1006, "Movie not exist", HttpStatus.NOT_FOUND),
